...
(function ($, Drupal, drupalSettings) {
  ...
  $.extend(
    ...
    /** @lends Drupal.theme */ {
       ...
       */
      tableDragToggle: () =>
        `<div class="tabledrag-toggle-weight-wrapper text-end" data-drupal-selector="tabledrag-toggle-weight-wrapper text-right">
            <button type="button" class="link tabledrag-toggle-weight btn btn-outline-default btn-sm" data-drupal-selector="tabledrag-toggle-weight"></button>
            </div>`,
      ...
      tableDragHandle(dragOrientation = 'drag') {
        ...
        class="tabledrag-handle"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-arrows-move" viewBox="0 0 16 16">
