    ...
    attach(context) {
      ...
      once('vertical-tabs', '[data-vertical-tabs-panes]', context).forEach(
        (verticalTab) => {
          ...
          // Check if the container width is more than widthBreakpoint to handle modal forms
          if ($this.width() < width) {
            return;
          }

          $this.addClass('vertical-tabs__panes col p-3');
          ...
          $details.each(function () {
            ...
            $summary.addClass('card-header d-none');
